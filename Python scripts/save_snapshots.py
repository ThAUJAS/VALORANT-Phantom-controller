...
def save_snaps(width=0, height=0, name="snapshot", raspi=False):
    folder = "C:/Projets/valorant_irl/camera_01"
    if raspi:
...
def main():
    ...
    save_snaps(width=args.dwidth, height=args.dheight, name=args.name, raspi=args.raspi)
